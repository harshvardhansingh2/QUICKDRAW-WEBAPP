...
document.getElementById("need_to_draw").innerText = "Sketch to be drawn : " + Element_of_array;
...
function gotResults(error, results)
{
    ...
    document.getElementById('sketch').innerText = 'Label : ' + drawn_sketch;

    document.getElementById('confidence').innerText = 'Confidence : ' + Math.round(results[0].confidence * 100) + "%";
}
